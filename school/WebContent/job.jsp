...
<head>
	...
	<script type="text/javascript">
	    ...
	    $(function(){
	    	var type = $("#type").val();
	    	type == "null" ? selectList(9) : selectList(10);
	    })
	</script>
	<style>
		...
		<div class="body">
			...
			<div class="body_left">
				<div class="body_left_menu">
					<p class="body_left_menu_title">招生就业</p>
					<p><a href="javascript:selectList(9)" class="body_left_menu_content">铁路就业</a></p>
					<p><a href="javascript:selectList(10)" class="body_left_menu_content">就业信息</a></p>
			...
			<div class="body_right">
				<p class="body_right_navigation">
					<span><a href="">首页</a></span> > 招生就业 >
					<span class="body_right_navigation_now">铁路就业</span>
				</p>

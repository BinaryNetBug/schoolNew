...
<head>
	...
	<script type="text/javascript">
	    ...
	    $(function(){
	    	var type = $("#type").val();
	    	type == "null" ? selectList(1) : selectList(2);
	    })
	</script>
	<style>
		...
		<div class="body">
			...
			<div class="body_left">
				<div class="body_left_menu">
					<p class="body_left_menu_title">文化园地</p>
					<p><a href="javascript:selectList(1)" class="body_left_menu_content">校园文化</a></p>
					<p><a href="javascript:selectList(2)" class="body_left_menu_content">学习园地</a></p>
			...
			<div class="body_right">
				<p class="body_right_navigation">
					<span><a href="">首页</a></span> > 文化园地 >
					<span class="body_right_navigation_now">校园文化</span>
				</p>

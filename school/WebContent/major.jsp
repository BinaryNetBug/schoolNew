...
<head>
	...
	<script type="text/javascript">
		$.ajax({
			...
			success:function(data) {
				...
				for(var i = 0;i<majorlist.length;i++){
					str+="<div class='aaa'><p style='text-align:center'><a href='javascript:void(0)' onclick='show("+majorlist[i].majorId+")' class='body_right_menu_content' id='mname'>"+majorlist[i].mName+"</a></p><div class='aaa_div'><a href='javascript:void(0)' onclick='show("+majorlist[i].majorId+")' class='body_right_menu_content'><img src='/school"+majorlist[i].mimage+"' alt='' width='100%' height='100%'></a></div><br><a href='javascript:void(0)'  onclick='show("+majorlist[i].majorId+")' class='body_right_menu_content'>"+majorlist[i].intro+"</a></div>"
				}
		...
		function show(id){
			$.ajax({
				type:"post",
				url:"selectOneMajor.action",
				data:"major.majorId="+id, 
				success:function(data) {
					console.log(data);
					var str2 = "<div></div>";
					var major = data.major;
					str2+="<div>"+major.article+"</div>"
					console.log(str2);
		...
		<div class="body">
			...
			<div class="body_left">
				<div class="body_left_menu">
					<p class="body_left_menu_title">专业设置</p>
					<p><a href="" class="body_left_menu_content">高铁（和谐号）、动车乘务专业</a></p>
					<p><a href="" class="body_left_menu_content">铁路运输/客运专业</a></p>
					<p><a href="" class="body_left_menu_content">铁路车辆运用与检修培养班</a></p>
					<p><a href="" class="body_left_menu_content">航空地勤服务专业</a></p>
					<p><a href="" class="body_left_menu_content">航空空乘服务专业</a></p>
					<p><a href="" class="body_left_menu_content">铁路轨道运输物流专业</a></p>
			...
			<div class="body_right">
				<p class="body_right_navigation">
					...
					<span><a href="">专业设置</a></span> >
					<span class="body_right_navigation_now"></span>
				</p>

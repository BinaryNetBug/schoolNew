		...
		<div class="body">
			...
			<div class="body_left">
				<div class="body_left_menu">
					<p class="body_left_menu_title">学院动态</p>
					<p><a href="javascript:selectList(7)" class="body_left_menu_content">新闻中心</a></p>
					<p><a href="javascript:selectList(8)" class="body_left_menu_content">通知公告</a></p>
			...
			<div class="body_right">
				<p class="body_right_navigation">
					<span><a href="">首页</a></span> > 学院动态 >
					<span class="body_right_navigation_now">新闻中心</span>
				</p>
